...
install_istio() {
  ...
  curl -o ${KUBEFLOW_K8S_MANIFESTS_DIR}/istio-crds.yaml \
    https://raw.githubusercontent.com/${KUBEFLOW_GH_REPO}/${KUBEFLOW_TAG}/dependencies/istio/install/crds.yaml

  # istio-ingressgateway is of type NodePort instead of LoadBalancer
  curl -o ${KUBEFLOW_K8S_MANIFESTS_DIR}/istio-noauth.yaml \
    https://raw.githubusercontent.com/${KUBEFLOW_GH_REPO}/${KUBEFLOW_TAG}/dependencies/istio/install/istio-noauth.yaml
